...
public class LoginTest {
    ...
    public void withValidCredentials() throws IOException {
        ...
        FileUtils.copyFile(screenshot, new File(System.getProperty("user.dir") + "/Lenovo_Firefox_LoginTest_screenshot.png"));
    ...
    public void withInvalidCredentials() throws IOException {
        ...
        File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(screenshot, new File(System.getProperty("user.dir") + "/Lenovo_Firefox_FailedLoginTest_screenshot.png"));
